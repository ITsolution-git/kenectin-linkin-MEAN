'use strict';
angular.module('app').controller('AppCtrl', ['$scope','auth', '$state', '$timeout','$rootScope', 'user', '$http', 'GlobalConstants', 
    function($scope, auth, $state, $timeout, $rootScope, user, $http, GlobalConstants) {
        ...
        $scope.app = {
            name: 'Slant Admin - Angular | Social Media',
            version: '4.0.1',
            type: 'socialmedia',
            color: {
                primary: '#5bc9c5',
