        ...
        ['$stateProvider', '$urlRouterProvider', 'JQ_CONFIG',
            function($stateProvider, $urlRouterProvider, JQ_CONFIG) {
                ...
                $stateProvider
                    ...
                    .state('app.soc-edit-profile', {
                        url: '/socialmedia/edit-profile',
                        templateUrl: 'partials/profile/edit-profile.html',
                        resolve: {
                            deps: ['uiLoad',
                                function(uiLoad) {
                                    return uiLoad.load([
                                        ...
                                        'js/controllers/profile/edit-profile.js',
                                        JQ_CONFIG.moment]);
                                }
                            ]
                        }
                    })
                    .state('app.soc-profile', {
                        url: '/socialmedia/profile/:id',
                        ...
                        resolve: {
                            deps: ['uiLoad',
                                function(uiLoad) {
                                    return uiLoad.load([
                                        '../bower_components/font-awesome/css/font-awesome.css',
                                        'js/controllers/profile/profile.js',
                                        JQ_CONFIG.moment]);
                                }
                            ]
                        }
