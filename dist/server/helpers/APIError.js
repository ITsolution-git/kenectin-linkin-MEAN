...
var ExtendableError = function (_Error) {
  ...
  function ExtendableError(message, status, isPublic, stack) {
...
var APIError = function (_ExtendableError) {
  ...
  function APIError(message) {
    ...
    return _possibleConstructorReturn(this, (APIError.__proto__ || Object.getPrototypeOf(APIError)).call(this, message, status, isPublic, stack));
  }
